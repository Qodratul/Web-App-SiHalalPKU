...
@section('title', 'Tambah Data UMKM - SiHalalPKU')
...
<div class="min-h-screen bg-white">
    ...
    <main class="max-w-[1440px] mx-auto px-3 md:px-4 pt-4 md:pt-8 pb-8 md:pb-12">
        ...
        <div class="mb-4 md:mb-8">
            <h1 class="text-xl md:text-5xl font-bold text-black text-shadow mb-1 md:mb-2">Tambah Data UMKM</h1>
            <p class="text-xs md:text-2xl font-semibold text-[#252525]">Tambah UMKM yang Terdata Halal</p>
        </div>

        <!-- Form -->
        <form action="{{ route('admin.umkm.store') }}" method="POST" enctype="multipart/form-data" data-loading="Menyimpan data UMKM">
            @csrf
            ...
            <div class="flex flex-col md:flex-row gap-4 md:gap-6">
                ...
                <div class="w-full md:w-[640px] md:flex-shrink-0">
                    ...
                    <div class="flex items-start gap-3 md:gap-6 mb-4 md:mb-6">
                        <div class="w-[100px] h-[100px] md:w-[187px] md:h-[187px] bg-gray-200 rounded-lg overflow-hidden flex items-center justify-center" id="image-preview">
                            <img src="{{ asset('images/placeholder_umkm.webp') }}" class="w-full h-full object-cover" alt="Preview">
                        </div>
                    ...
                    <div class="mb-3 md:mb-4">
                        ...
                        <textarea name="deskripsi" 
                                  ...
                                  placeholder="Tuliskan deskripsi UMKM di sini...">{{ old('deskripsi') }}</textarea>
                    </div>
                </div>
                ...
                <div class="flex-1">
                    ...
                    <div class="bg-[#f6f6f6] border border-[#2d7e37] rounded-[16px] md:rounded-[24px] shadow-md p-3 md:p-6 min-h-[280px] md:min-h-[409px]">
                        <!-- Product Form -->
                        <div id="product-form" class="mb-4 md:mb-6">
                            <!-- Product Image -->
                        ...
                        <div class="mt-3 md:mt-4">
                            <button type="button" 
                                    ...
                                    class="px-3 md:px-4 py-1.5 md:py-2 bg-[#f6f6f6] border border-[#2d7e37] rounded-[16px] md:rounded-[24px] shadow-md text-xs md:text-base text-[#333] font-bold hover:bg-gray-100 transition-colors hidden">
                                + Tambah Produk
                            </button>
                        </div>
                    </div>
